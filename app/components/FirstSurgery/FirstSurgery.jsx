      ...
      <div className={styles.firstSurgerySection}>
        ...
        {isDpkOpen && (
          <div className={styles.firstSurgeryTitle}>
            <div className={styles.firstSurgeryText}>
              <p>
                Виразка ДПК в неускладненній її формі є недугом терапевтичним і
                при дотриманні всіх лікарських рекомендацій як правело приводить
                до виздоровлення з заживленням виразкового дефекту. Але
                ускладненнями виразкової хвороби ДПК, уже займаються хірурги.
                Тому щоб не допустити до ускладнень, хворий має добре
                усвідомлювати що при будть яких болів в животі потрібно
                звернутися до лікаря
              </p>
              <h4>Симптоми виразки ДПК</h4>
              <ul>
                <li>
              ...
              <h4>Ускладнення виразкової хвороби ДПК</h4>

              <h5>Кровотеча з втразки ДПК</h5>
              <p>
                Блювота кавовою гущею і виділення чорного стільця "мелена",
                виражена слабкість{' '}
              </p>

              <h5>Проривна виразка</h5>
              <p>
                Різкі болі в правій половині живота серед "повного здоров'я".
                Хворого доставляє в лікарню карета швидкої допомоги і
                проводяться діагностично-лікувальні заходи{' '}
              </p>
              ...
              <p>
                <u>
                  ...
                  стінки кишки і дно виразки переходить на той орган, який
                  прилягає до ДПК.
                </u>{' '}
                Якщо це внутрішня стінка, яка прилягає до підшлункової залози,
                то часто виникають запалання її - панкреатит.
              </p>
            ...
            <div className={styles.firstSurgeryImage}>
              ...
              <img
                src="/images/dpk/dpkUlcer.jpg" // Шлях до зображення з папки public
                alt="Doctor"
                width={600}
                height={600}
                // className={styles.tunnelImage}
