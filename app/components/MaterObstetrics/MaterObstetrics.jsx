          ...
          <div className={styles.materObstetricsTitle}>
            <div className={styles.materObstetricsText}>
              ...
              <ul>
                ...
                <li>
                  побачити грубі вади розвитку і/або ознаки генетичних аномалій
                  (які можуть сприяти перериванню вагітності): вимірюють товщину
                  шийно-комірного простору, розміри носових кісток, окружність
                  голови, купреко-тім’яний розмір,
                </li>
